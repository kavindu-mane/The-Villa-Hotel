...
import { FaRegCheckCircle, FaFile, FaTrash } from "react-icons/fa";
...
const variants = {
  base: "relative rounded-md p-4 w-full min-h-40 max-w-[calc(100vw-1rem)] flex justify-center items-center flex-col cursor-pointer border border-dashed border-gray-400 dark:border-gray-300 transition-colors duration-200 ease-in-out",
  active: "border-2",
  disabled:
          ...
          <div>
            ...
            >
              ...
              <div className="flex flex-col items-center justify-center text-xs text-gray-400">
                <IoCloudUploadOutline className="mb-1 h-7 w-7" />
          ...
          {value?.map(({ file, progress }, i) => (
            ...
            >
              <div className="flex items-center gap-2 text-gray-500 dark:text-white">
                <FaFile size="30" className="shrink-0" />
                ...
                <div className="flex w-12 justify-end text-xs">
                  {progress === "PENDING" ? (
                    ...
                    <RiFileWarningFill className="shrink-0 text-red-600 dark:text-red-400" />
                  ) : progress !== "COMPLETE" ? (
                    <div>{Math.round(progress)}%</div>
                  ) : (
                    <FaRegCheckCircle className="shrink-0 text-green-600 dark:text-gray-400" />
                  )}
                </div>
              </div>
              {/* Progress Bar */}
