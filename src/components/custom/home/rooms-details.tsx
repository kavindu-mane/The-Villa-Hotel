...
export const RoomsDetails: FC = () => {
  ...
  return (
    <section
      className="z-0 -my-[12rem] flex h-screen min-h-[60rem] w-screen flex-col justify-between bg-cover bg-fixed bg-center px-3 "
      style={{ backgroundImage: "url(/images/img_15.jpg)" }}
    >
      <div className="-mx-3 h-[20vh] min-h-[12rem] w-screen bg-gray-50" />
      <div className="-mx-3 flex h-[60vh] min-h-[36rem] flex-col items-center justify-center space-y-2 bg-slate-950/70 px-2">
        {/* heading */}
        ...
        >
          <motion.div
            ...
            dragConstraints={{
              top: 0,
              left: isOverflow ? getGrabWidth() * -2 : 0,
              right: 0,
              bottom: 0,
            }}
